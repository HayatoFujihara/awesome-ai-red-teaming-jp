...
|--------|------:|------|-----------|------|
| [Promptfoo](https://github.com/promptfoo/promptfoo) | ~22,400 | TypeScript | MIT | RAG・エージェント・MCPテスト対応、コンプライアンスマッピング |
| [Garak](https://github.com/NVIDIA/garak) | ~8,100 | Python | Apache 2.0 | NVIDIA開発、プローブモジュール多数、学術的アプローチ |
| [PyRIT](https://github.com/microsoft/PyRIT) | ~4,000 | Python | MIT | Microsoft開発、マルチモーダル対応、80+種類の変換器 |
| [DeepTeam](https://github.com/confident-ai/deepteam) | ~1,900 | Python | Apache 2.0 | データセット不要の動的テストケース生成、OWASP/NIST対応 |
| [MLCommons ModelBench](https://github.com/mlcommons/modelbench) | ~130 | Python | Apache 2.0 | AILuminate安全性ベンチマークの実行・集計・レポート生成 |
...
- [mlcommons/modelbench](https://github.com/mlcommons/modelbench) - MLCommons AI Risk & Reliability Working Groupによる安全性ベンチマーク実行ツール。ModelGaugeでSUT（評価対象システム）を実行し、AILuminateのハザード別スコアとレポートを生成
...
- [AVID (AI Vulnerability Database)](https://avidml.org/) - 汎用AI（GPAI）システムの失敗モードや脆弱性レポートを、証拠・メタデータ・再現可能な評価情報とともに収録するオープンデータベース。データ本体は [avidml/avid-db](https://github.com/avidml/avid-db)、開発者向けPythonツールは [avidml/avidtools](https://github.com/avidml/avidtools)
...
- [MLCommons AILuminate](https://mlcommons.org/benchmarks/ailuminate/) - MLCommonsのAIリスク・信頼性ベンチマーク。Safety v1.0は12のハザードカテゴリで一般目的チャットシステムを単一ターン評価し、英語・フランス語の公開結果を提供。実行基盤は [ModelBench](https://github.com/mlcommons/modelbench)
